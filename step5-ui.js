...
2. **Ha**: Integrasi metode wearable dan diari...
   **H0**: Integrasi metode wearable dan diari...`, hasCheckbox: true },
        ...
        { id: 'slrmetode', title: '2. Metode PRISMA (Review SLR)', promptText: `METODE SYSTEMATIC LITERATURE REVIEW (PRISMA)\n\nTopik/Judul: [JUDUL]\n\nATURAN OUTPUT MUTLAK:\n- DILARANG menulis ulang kata "Metode PRISMA".\n- Buat 3-4 paragraf akademik yang menguraikan metode systematic review mengadopsi panduan PRISMA (Preferred Reporting Items for Systematic Reviews and Meta-Analyses).\n- Wajib memuat sub-bagian berikut (Tebalkan judul sub-bab):\n  **A. Strategi Pencarian Literatur:** Sebutkan database akademik yang digunakan (misal: Scopus, IEEE Xplore, Google Scholar) dan buatkan simulasi kata kunci (search string) yang logis untuk topik penelitian di atas.\n  **B. Kriteria Inklusi dan Eksklusi:** Buat rincian kriteria jurnal yang dipilih (misalnya: dipublikasikan 5 tahun terakhir, harus artikel penelitian orisinal, dll) dan kriteria yang ditolak (misal: sekadar opini atau tidak full-text).\n  **C. Proses Ekstraksi Data:** Uraikan secara ringkas bagaimana tahapan penyaringan data dilakukan dari pencarian awal hingga tersisa jurnal utama yang direview.\n- TANPA BASA-BASI AI.` },
